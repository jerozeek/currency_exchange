...
<?php
$allTransactions            = $transactions->where(['status' => 'success', 'transaction_type' => $_GET['type'], 'user_id' => $_GET['user']])->orderBy('id','DESC')->get()->getResult();
...
$NGN_deposit = 0;
$NGN_charges = 0;
$currencyTransactions = $transactions->where(['status' => 'success', 'transaction_type' => $_GET['type'], 'currency' => 'NGN', 'user_id' => $_GET['user']])->orderBy('id','DESC')->get()->getResult();
...
$EUR_deposit = 0;
$EUR_charges = 0;
$currencyTransactions = $transactions->where(['status' => 'success', 'transaction_type' => $_GET['type'], 'currency' => 'EUR', 'user_id' => $_GET['user']])->orderBy('id','DESC')->get()->getResult();
foreach ($currencyTransactions as $currencyTransaction)
{
...
$USD_deposit = 0;
$USD_charges = 0;
$currencyTransactions = $transactions->where(['status' => 'success', 'transaction_type' => $_GET['type'], 'currency' => 'USD', 'user_id' => $_GET['user']])->orderBy('id','DESC')->get()->getResult();
foreach ($currencyTransactions as $currencyTransaction)
{
...
$GBP_deposit = 0;
$GBP_charges = 0;
$currencyTransactions = $transactions->where(['status' => 'success', 'transaction_type' => $_GET['type'], 'currency' => 'GBP', 'user_id' => $_GET['user']])->orderBy('id','DESC')->get()->getResult();
foreach ($currencyTransactions as $currencyTransaction)
{
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title"><?=$userModel->find($_GET['user'])->first_name . ' '. $userModel->find($_GET['user'])->last_name . ' '. ucfirst($_GET['type'])?> Overview</h3>
