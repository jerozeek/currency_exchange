            ...
            <div class="nk-content ">
                <div class="nk-block nk-block-middle wide-xs mx-auto">
                    <div class="nk-block-content nk-error-ld text-center">
                        ...
                        <p class="nk-error-text">You do not have access to this module. Please contact super admin</p>
                        <a href="<?=previous_url()?>" class="btn btn-lg btn-primary mt-2">Back To Home</a>
                    </div>
                </div><!-- .nk-block -->
            </div>
            <!-- wrap @e -->
